{{-- mewarisi atau mengambil template utama pada folder backend, sehingga kita dapat menggunakan semua kode yang ada di dalamnya. --}}
@extends('backend.template')

{{-- blok kode yang mengelompokkan konten utama aplikasi. Bagian ini akan diisi dengan konten yang spesifik untuk halaman atau bagian aplikasi tertentu. --}}
@section('content')
